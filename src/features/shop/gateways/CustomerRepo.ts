...
export class CustomerRepo {
  public static async readCustomer(id: number): Promise<RepoCustomer | null> {
  ...
  public static async readCustomerByModule(module: number): Promise<RepoCustomer | null> {
    const client = await knex
